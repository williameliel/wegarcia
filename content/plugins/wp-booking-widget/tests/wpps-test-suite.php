 ...
 */
if ( ! class_exists( 'WPBWTestSuite' ) ) {
	class WPBWTestSuite extends TestSuite {
		function __construct() {
			parent::__construct();

			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-wpbw-module.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-wpbw-settings.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-wpbw-instance-class.php' );
		}
