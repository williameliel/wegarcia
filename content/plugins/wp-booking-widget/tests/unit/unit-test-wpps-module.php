...
require_once( dirname( dirname( __DIR__ ) ) . '/classes/wpbw-module.php' );

/**
 * Unit tests for the WPBW_Module class
 * Uses the SimpleTest For WordPress plugin
 *
 * @link http://wordpress.org/extend/plugins/simpletest-for-wordpress/
 */
if ( ! class_exists( 'UnitTestWPBW_Module' ) ) {
	class UnitTestWPBW_Module extends UnitTestCase {
		/*
		 * get_instance()
		 */
		public function test_get_instance() {
			// Two instances of the same module
			$first_instance = WPBWChildClass::get_instance();
			$first_instance->init();
			$first_instance->foo = 'first';

			$second_instance = WPBWChildClass::get_instance();
			...
			$separate_module = WPBWAnotherChildClass::get_instance();
		...
		public function test_magic_get() {
			$child = WPBWChildClass::get_instance();
	...
	} // end UnitTestWPBW_Module
}

// Mock up a child class
if ( ! class_exists( 'WPBWChildClass' ) ) {
	class WPBWChildClass extends WPBW_Module {
...
// Mock up a child class
if ( ! class_exists( 'WPBWAnotherChildClass' ) ) {
	class WPBWAnotherChildClass extends WPBW_Module {
